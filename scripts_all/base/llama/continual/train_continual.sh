...
SFT_MODEL_NAME=${SFT_MODEL_NAME:-"llama_base_sft_model"}
...
export CHECKPOINT_BASE_DIR=${CHECKPOINT_BASE_DIR:-/nas/shared/sys2/yuanhangli/tmp/checkpoints/llama_base/continual_countdown3b_llama_curriculum}
