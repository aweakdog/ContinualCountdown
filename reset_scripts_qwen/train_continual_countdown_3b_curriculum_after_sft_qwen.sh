...
export LAYER_RESET_K_FIRST=${LAYER_RESET_K_FIRST:-2}    # Reset first 4 transformer layers
export LAYER_RESET_K_LAST=${LAYER_RESET_K_LAST:-2}      # Reset last 2 transformer layers
export LAYER_RESET_STEPS=${LAYER_RESET_STEPS:-"[2,30]"}  # Reset at global steps 120 and 200
