...
SFT_CHECKPOINT=global_step_0_instruct
...
EXP_LOG_DIR=./llama_logs/train_countdown3b_llama_sft_${SFT_CHECKPOINT}_reset_k${LAYER_RESET_K_FIRST}f_k${LAYER_RESET_K_LAST}l
mkdir -p "$EXP_LOG_DIR"
