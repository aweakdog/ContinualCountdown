...
export CHECKPOINT_BASE_DIR=${CHECKPOINT_BASE_DIR:-./checkpoints/deepmath_llama3b_ppo}
export BASE_MODEL=${BASE_MODEL:-"./models/llama_instruct_sft_models/${SFT_CHECKPOINT}"}
