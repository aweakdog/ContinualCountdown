...
show_usage() {
    ...
    echo "  --model        Path to base model (default: ./models/qwen_instruct3b)"
...
SFT_SIZE=${1:-2048}
NUM_GPUS=8
BASE_MODEL="./models/qwen_instruct3b"
WANDB_MODE="disabled"
...
CONFIG_PATH="./verl/trainer/config/sft_qwen_instruct_trainer.yaml"
